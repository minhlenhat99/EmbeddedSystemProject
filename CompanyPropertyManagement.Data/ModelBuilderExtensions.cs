...
namespace CompanyPropertyManagement.Data
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            {
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[0].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[0].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[0].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[0].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[0].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[1].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[1].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[1].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[1].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[1].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[2].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[2].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[2].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[2].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[2].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[3].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[3].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[3].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[3].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[3].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[4].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[4].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[4].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[4].Id},
                new Property { Id = Guid.NewGuid(), BuId = bus[0].Id, CategoryId = categories[4].Id},
